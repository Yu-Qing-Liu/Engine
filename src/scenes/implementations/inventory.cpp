...
void Inventory::createScrollBar() {
...
void Inventory::dragSliderToCursor() {
...
void Inventory::updateUniformBuffers() {
	if (!usingSlider) {
...
void Inventory::renderPass() { scrollBar->render(); }
