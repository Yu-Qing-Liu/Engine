...
OBJModel::OBJModel(const std::string &objPath, const std::vector<TexVertex> &vertices, const std::vector<uint16_t> &indices) : objPath(objPath), Model(Engine::shaderRootPath + "/texture", vertices, indices) {
...
void OBJModel::createDescriptorSetLayout() {
...
void OBJModel::createDescriptorPool() {
...
void OBJModel::createDescriptorSets() {
...
void OBJModel::createTextureImage() {
...
void OBJModel::createTextureImageView() { textureImageView = Engine::createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT); }

void OBJModel::createTextureSampler() {
...
void OBJModel::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
void OBJModel::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = Engine::beginSingleTimeCommands();
