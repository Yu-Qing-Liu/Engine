...
class Application {
  ...
  private:
	...
	void createGraphicsPipeline() {
		auto vertShaderCode = readFile("/home/admin/Containers/vulkan/Engine/src/shaders/triangle/vert.spv");
		auto fragShaderCode = readFile("/home/admin/Containers/vulkan/Engine/src/shaders/triangle/frag.spv");
